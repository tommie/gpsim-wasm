...
start	
   ...
   .sim "module load ds18b20 dstemp1"
   .sim "module load ds18b20 dstemp2"
   .sim "module load pu pu1"
   .sim "node n1"
   .sim "attach n1 pu1.pin portc0 dstemp1.pin"
   ;.sim "attach n1 pu1.pin portc0 dstemp1.pin dstemp2.pin" 
   .sim "pu1.xpos = 240"
   .sim "pu1.ypos = 188"
   .sim "pu1.resistance = 4700"
   .sim "dstemp1.xpos = 240"
   .sim "dstemp1.ypos = 50"
   .sim "dstemp1.powered = false"
   .sim "dstemp2.xpos = 240"
   .sim "dstemp2.ypos = 110"
   .sim "dstemp2.ROMCode = 0x06050403020200"
   .sim "dstemp2.temperature = -25.4"
   .sim "dstemp2.config_register = 0x3f"
   ...
   .sim "scope.ch0=\"portc0\""
	...
	call	searchRom
	call	read_rom
   .assert "W==0x28,\"DS18B20 family code 0x28\""
	call	check_power
   .assert "W==0x00,\"DS18B20 temp1 parasite power\""
	nop
	call	power_on_val
	call	read_temp
   .assert "Tlsb==0x90,\"Temperature Reading lsb 0x90 (25C)\""
	nop
   .assert "Tmsb==0x01,\"Temperature Reading msb 0x01 (25C)\""
	nop
	call 	write_ThTl
	call	eeprom2scratch

two
   .command "attach n1 dstemp2.pin"
	nop
   ...
   .assert "W==0x80,\"DS18B20 temp2 external power\""
	...
	call	power_on_val
	call	read_temp
   .assert "(Tlsb&0xfc)==0x68,\"Temperature Reading lsb 0x68 (-25.4C)\""
	nop
   .assert "Tmsb==0xfe,\"Temperature Reading msb 0xFE (-25.4C)\""
	nop
	call	alarmSearch
	call 	write_ThTl
	call	eeprom2scratch
