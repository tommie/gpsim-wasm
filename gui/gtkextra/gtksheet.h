...
#ifndef gtkextra_GTK_SHEET_H_
#define gtkextra_GTK_SHEET_H_
...
#define GTK_SHEET_CLASS(klass)  G_TYPE_CHECK_CLASS_CAST (klass, gtk_sheet_get_type (), GtkSheetClass)
